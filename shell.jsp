...
<style>
    :root{--background-color:#000;--color:#0f0;--txt-color:#fff;--txt-hover-color:#fff;--border-color:#260}select{line-height:25px;background-color:var(--background-color);color:var(--color);border-color:var(--border-color);border-radius:4px;margin:2px;padding:0 10px;appearance:none;-moz-appearance:none;-webkit-appearance:none;position:relative;cursor:pointer}body{background:var(--background-color);color:var(--color);font-family:monospace;font-size:13px}a{color:var(--color);text-decoration:none}a:hover{color:var(--txt-hover-color)}a.active{color:var(--txt-color)}a.action{border-radius:4px;font-size:12px;padding:5px;margin:0 1px 0 1px;background:#111;color:var(--color);border:1px solid #222;cursor:pointer;outline:0;display:inline-block}a.action:hover{background:#222;border:1px solid #333}.menu{overflow:hidden;border-top:1px solid var(--border-color);border-bottom:1px solid var(--border-color);margin:10px 0}.menu>ul{list-style:none;margin:0;padding:0}.menu>ul>li{margin:0 3px 0 0;padding:10px 7px 10px 7px;display:block;float:left}.menu>ul>li:hover{cursor:pointer}.col-error{color:red}.col-warn{color:#ff0}.col-normal{color:#00bfff}.wrapper{width:93%;margin:37px auto 40px;margin-top:12px}.menu-directory{margin-bottom:10px}#map-switch{display:inline-block}#map1{margin-right:10px;display:inline-block}#map2{display:none;width:90%}.content{border:1px solid var(--border-color);padding:10px;overflow:auto;overflow-y:hidden}#info{float:right}.copyright{text-align:center}input[type=submit]{background:#111;border:1px solid var(--border-color);color:var(--color);line-height:25px;padding:0 10px;cursor:pointer;outline:0;border-radius:4px;margin:2px}input[type=submit]:hover{background:#222;border:1px solid var(--border-color)}#filemenu-upload{left:-9999px;position:absolute}.table{width:100%;margin:10px 0}.table td,th{padding:5px;border:1px solid var(--border-color);max-width:250px;min-width:25px}.table td.kanan{word-break:break-word}.table td.kiri{width:30%}.table tr:nth-child(odd){background:#000}.table tr:nth-child(even){background:#111}.table tr:hover td{background:#222}.table tfoot td{padding:10px;text-align:center}.sortable thead{cursor:pointer}textarea{border:1px solid var(--border-color);background:var(--background-color);color:var(--color);width:100%;padding:15px;min-height:300px;outline:0;box-sizing:border-box;resize:none}input[type=text]{background:var(--background-color);line-height:15px;color:var(--color);border:1px solid var(--border-color);padding:5px;outline:0;box-sizing:border-box;border-radius:4px;margin:2px}input[type="checkbox"]{width:14px;height:14px;display:inline-block;text-align:center;vertical-align:middle;line-height:14px;position:relative}input[type="checkbox"]::before{content:"";position:absolute;top:0;left:0;background:var(--background-color);width:100%;height:100%;border:1px solid var(--border-color)}input[type="checkbox"]:checked::before{content:"\2713";background-color:var(--background-color);position:absolute;top:0;left:0;width:100%;border:1px solid var(--border-color);color:#ff0;font-size:18px;font-weight:bold}
</style>
